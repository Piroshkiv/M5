...
public class CatalogServiceTest
{
    ...
    public async Task GetCatalogItemsAsync_Success()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetByPageAsync(
            ...
            It.Is<int>(i => i == testPageSize))).ReturnsAsync(pagingPaginatedDataSuccess);
    ...
    public async Task GetCatalogItemsAsync_Failed()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetByPageAsync(
            It.Is<int>(i => i == testPageIndex),
            It.Is<int>(i => i == testPageSize))).Returns((Func<PaginatedDataResponse<CatalogItemDto>>)null!);
    ...
    public async Task GetCatalogBrandsAsync_Success()
    {
        ...
        var pagingPaginatedDataSuccess = new PaginatedData<CatalogBrand>()
        {
    ...
    public async Task GetCatalogBrandsAsync_Failed()
    {
        ...
        _catalogBrandRepository.Setup(s => s.GetByPageAsync(
            It.Is<int>(i => i == testPageIndex),
            It.Is<int>(i => i == testPageSize))).Returns((Func<PaginatedDataResponse<CatalogBrandDto>>)null!);
    ...
    public async Task GetCatalogTypesAsync_Success()
    {
        ...
        var pagingPaginatedDataSuccess = new PaginatedData<CatalogType>()
        {
    ...
    public async Task GetCatalogTypesAsync_Failed()
    {
        ...
        _catalogTypeRepository.Setup(s => s.GetByPageAsync(
            It.Is<int>(i => i == testPageIndex),
            It.Is<int>(i => i == testPageSize))).Returns((Func<PaginatedDataResponse<CatalogTypeDto>>)null!);
