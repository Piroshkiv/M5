...
public class CatalogItemServiceTest
{
    ...
    public async Task UpdateAsync_Success()
    {
        ...
        // act
        var result = await _catalogService.UpdateAsync(_testItem.Id, _testItem.Name, _testItem.Description, _testItem.Price, _testItem.AvailableStock, _testItem.CatalogBrandId, _testItem.CatalogTypeId, _testItem.PictureFileName);
