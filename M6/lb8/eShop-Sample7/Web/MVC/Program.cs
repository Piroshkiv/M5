...
builder.Services.AddAuthentication(options =>
    ...
    .AddOpenIdConnect(options =>
    {
        ...
        options.Scope.Add("basket.basketproduct");
...
builder.Services.AddTransient<IOrderService, OrderServer>();
...
app.UseEndpoints(endpoints =>
{
    ...
    endpoints.MapControllerRoute("Basket", "{controller=Index}/{action=Index}");
